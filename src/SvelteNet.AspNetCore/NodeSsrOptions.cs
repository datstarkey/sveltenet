...
/// <summary>Options specific to the Node.js SSR backend.</summary>
public sealed class NodeSsrOptions
{
	/// <summary>Node.js executable name or absolute path.</summary>
	public string ExecutablePath { get; set; } = "node";
